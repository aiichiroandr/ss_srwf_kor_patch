...
`srwf-f-20260814-v0-1-1`, 그리고 F 완결편 `srwf-final-20260921-v0-1-a/b/c`
글꼴 변형이 등록되어 있습니다. 2026.08.14 시험판은 공개 인덱스에서 제외하고 역사 자료로만 남겨 두었습니다. 각 payload는 독립된
...
R7 완료는 주장하지 않습니다. 이 범위는 [`FIN_V01_R110_BUILD_RECEIPT.json`](FIN_V01_R110_BUILD_RECEIPT.json)에 고정합니다.
