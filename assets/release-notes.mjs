...
export const PATCH_NOTES = Object.freeze({
  ...
  "srwf-f-20260823-v0-3": release(
    "v0.3",
    "전투 대사 세 줄의 화면 폭 초과를 잡고, 시나리오에 남아 있던 화자명 「닥터 헬」을 「Ｄｒ．헬」로 통일했습니다. 대사 초안 2,444건을 함께 반영했습니다. 배포 전 전수 검사에서 시나리오 7,145행·전투 5,989행·격추 166행 모두 화면 폭 초과가 없음을 확인했습니다. 이 판은 엔딩 크레딧을 일본어 원본으로 되돌렸습니다 — 한글 크레딧 영상은 공개 패치 형식의 record 상한을 넘겨 담을 수 없었고, 다음 판에서 형식을 넓혀 다시 넣습니다. 전투 화면의 파일럿 이름표도 아직 「Ｄｒ헬」이며 함께 정리합니다.",
    [],
  ),
